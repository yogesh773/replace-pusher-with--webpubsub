...
export class WebPubSubGroupImpl {
    ...
    listConnections(options = {}) {
        return tracingClient.withSpan("WebPubSubGroupClient.listConnections", options, (updatedOptions) => this.client.webPubSub.listConnectionsInGroup(this.hubName, this.groupName, updatedOptions));
    }
}

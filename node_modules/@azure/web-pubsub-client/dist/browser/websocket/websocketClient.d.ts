...
export declare class WebSocketClient implements WebSocketClientLike {
    private _socket;
    constructor(uri: string, protocolName: string);
    onopen(fn: () => void): void;
...
export declare class WebSocketClientFactory implements WebSocketClientFactoryLike {
    create(uri: string, protocolName: string): WebSocketClient;
}
//# sourceMappingURL=websocketClient-browser.d.mts.map